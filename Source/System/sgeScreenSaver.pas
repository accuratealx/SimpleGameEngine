...
type
  ...
  public
    ...
    procedure Run; override;                //Запуск хранителя
...
constructor TsgeScreenSaver.Create(InitSound: Boolean);
var
  Prm1, s: String;
  pw: Integer;
  Rct: TRect;
...
begin
  s := 'No settings present';
  if LoadString(HINSTANCE, 255, Buf, Length(Buf)) <> 0 then s := Buf;

...
const
  _UNITNAME = 'sgeSoundBufferWavLoader';
    ...
    while Pos < Stream.Size do
      ...
      if Header = 'fmt ' then
        ...
        if FmtHeader.FormatCode <> WAVE_FORMAT_PCM then
          raise EsgeException.Create(_UNITNAME, Err_UnsupportedFormat, IntToStr(FmtHeader.FormatCode));
        ...
        case FmtHeader.ChannelNumber of
          ...
          1:case FmtHeader.BitsPerSample of
              ...
              16: FFormat := AL_FORMAT_MONO16;
                ...
                raise EsgeException.Create(_UNITNAME, Err_BitsPerSampleNotSupport, IntToStr(FmtHeader.BitsPerSample));
            end;
          ...
          2:case FmtHeader.BitsPerSample of
            ...
            raise EsgeException.Create(_UNITNAME, Err_ChannelNumberNotSupport, IntToStr(FmtHeader.ChannelNumber));
        end;
